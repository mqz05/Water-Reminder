...
struct ImageView: View {
    var body: some View {
        VStack(spacing: 80) {
            ...
            Image(systemName: "house.circle.fill").resizable().frame(maxWidth: 100, maxHeight: 100).clipShape(Circle()).overlay(Circle().stroke(Color.blue, lineWidth: 6)).shadow(color: Color.blue, radius: 20).padding(.trailing, 700)
